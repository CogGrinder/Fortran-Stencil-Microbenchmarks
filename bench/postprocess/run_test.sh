...
do
    ...
    python3 codegen.py --size $size --kernel-mode DEFAULT_KERNEL -c -nv -A 2 #--module True #--size-range 128 4096 1024 # --hardware CPU --allocation STATIC
    ./run_bench_tree.sh #-vout #-vompgpu
    cd ../postprocess
